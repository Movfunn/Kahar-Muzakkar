...
document.querySelector(":root").style.setProperty("--customColor", "");
...
new TypeIt("#type1", {
  ...
  .type("Lahir : Luwu, 24 Maret 1920", { delay: 400 })
  .pause(500)
  .delete(27)
  .type("Tokoh Perjuangan Indonesia.", { delay: 400 })
  .pause(500)
  .delete(9)
  .go();
...
new TypeIt("#type2", {
  ...
  .type("Mengenai Pemberontakan Kahar Muzakkar..", { delay: 60000 })
  .pause(500)
  .delete(23)
  .go();
...
new TypeIt("#type3", {
  ...
  .type("Tindakan Yg Dilakukan Pemerintah..", { delay: 60000 })
  .pause(500)
  .delete(23)
  .go();
